...
class DetailedHotelTable extends StatelessWidget {
  final List<HotelBookingEntity> bookings;

  const DetailedHotelTable({super.key, required this.bookings});
  ...
  DataRow _buildDataRow(HotelBookingEntity booking) {
    return DataRow(
      cells: [
        DataCell(
        ...
        DataCell(
          Text(
            '${DateFormat('MM/dd').format(booking.checkIn)} - ${DateFormat('MM/dd').format(booking.checkOut)}',
