...
class CreateB2BCarBookingDialog extends StatefulWidget {
  const CreateB2BCarBookingDialog({super.key});

  @override
  State<CreateB2BCarBookingDialog> createState() => _CreateB2BCarBookingDialogState();
}

class _CreateB2BCarBookingDialogState extends State<CreateB2BCarBookingDialog> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField('موديل السيارة', _carModelController),
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(child: _buildTextField('مكان التسليم', _returnLocationController)),
                    ],
                  ),
                  const SizedBox(height: 16),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 16),
                      BlocConsumer<B2BCarBookingsCubit, B2BCarBookingsState>(
                        ...
                        builder: (context, state) {
                          return ElevatedButton(
                            onPressed: state is B2BCarBookingCreating ? null : _submit,
                            ...
                            child: state is B2BCarBookingCreating
                                ? const SizedBox(
                                    width: 20,
                                    height: 20,
  ...
  Future<void> _submit() async {
    if (_formKey.currentState!.validate()) {
      ...
      await context.read<B2BCarBookingsCubit>().createCarBooking(booking);
    }
  }
}
